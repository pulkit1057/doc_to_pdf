...
export declare const importsMapParagraphFormatBase: {
 ...
 */
export declare abstract class ParagraphFormatBase extends LinkElement {
    /**
     * Attribute type map
     */
     ...
     */
    alignment: ParagraphFormatBase.AlignmentEnum;
    /**
     ...
     */
    dropCapPosition: ParagraphFormatBase.DropCapPositionEnum;
    /**
     ...
     */
    lineSpacingRule: ParagraphFormatBase.LineSpacingRuleEnum;
    /**
     ...
     */
    outlineLevel: ParagraphFormatBase.OutlineLevelEnum;
    /**
     ...
     */
    styleIdentifier: ParagraphFormatBase.StyleIdentifierEnum;
    /**
     ...
     */
    shading: Shading;
    constructor(init?: Partial<ParagraphFormatBase>);
 ...
 */
export declare namespace ParagraphFormatBase {
    enum AlignmentEnum {
        Left,
        Center,
        Right,
